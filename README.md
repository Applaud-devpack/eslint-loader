# @applaud/eslint-loader [![Build Status](https://travis-ci.org/webpack-contrib/eslint-loader.svg?branch=master)](https://travis-ci.org/webpack-contrib/eslint-loader)
...
```console
$ npm install @applaud/eslint-loader --save-dev
```
